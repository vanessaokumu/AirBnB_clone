...
class HBnBCommand(cmd.Cmd):
    ...
    def default(self, arg):
        ...
        if match is not None:
            ...
            if match is not None:
                command = [argl[1][:match.span()[0]], arg[match.span()[1:-1]]
    ...
    def do_all(self, arg):
        ...
        Display string representationd of all instances of a given class
        ...
        if len(argl) == 4:
            ...
            for k, v in eval(argl[2]).items():
                if (k in obj.__class__.__dict__.keys() and
                    ...
                    valtype = type(obj._-class__.__dict__[k])
